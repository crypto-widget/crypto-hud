...
- **استهلاك خفيف بالأرقام**: في الاختبار الافتراضي بأداة واحدة و
  <bdi dir="ltr">3</bdi> أزواج سوق وتحديث كل <bdi dir="ltr">5</bdi> ثوانٍ،
  بلغ متوسط المعالج في الحالة المستقرة <bdi dir="ltr">0.070%</bdi>، وبلغت
  الذاكرة الخاصة للعملية نحو <bdi dir="ltr">20 MiB</bdi>.
  [عرض تقرير الأداء الكامل](docs/performance-reports/README.ar.md).
