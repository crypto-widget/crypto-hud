...
const ZH_HANT_TEXT: UiText = UiText {
    ...
    market_fallback: "異常時切換備援源",
    market_fallback_help: "目前資料源異常時自動切換備援源。",
    alert_settings: "警示規則",
    alert_enabled: "啟用警示",
    alert_symbol: "交易對",
    alert_condition: "條件",
...
const ES_419_TEXT: UiText = UiText {
    ...
    market_fallback: "Usar otra fuente si falla",
    market_fallback_help: "Cambia de fuente cuando el feed actual falla.",
...
const PT_BR_TEXT: UiText = UiText {
    ...
    market_fallback: "Usar outra fonte se falhar",
    market_fallback_help: "Troca a fonte quando o feed atual falha.",
...
const VI_TEXT: UiText = UiText {
    ...
    market_fallback: "Dùng nguồn dự phòng khi lỗi",
    market_fallback_help: "Tự đổi nguồn khi feed hiện tại bị lỗi.",
    ...
    runtime_stale: "Đã cũ",
    runtime_fallback: "Nguồn dự phòng",
...
const ID_TEXT: UiText = UiText {
    ...
    market_fallback: "Pakai sumber cadangan saat gagal",
    market_fallback_help: "Beralih sumber saat feed saat ini gagal.",
...
const TR_TEXT: UiText = UiText {
    ...
    market_fallback: "Hata olursa başka kaynak kullan",
    market_fallback_help: "Geçerli feed başarısız olursa kaynağı değiştirir.",
...
const KO_TEXT: UiText = UiText {
    ...
    market_fallback: "실패 시 다른 소스 사용",
    market_fallback_help: "현재 피드가 실패하면 소스를 전환합니다.",
...
const JA_TEXT: UiText = UiText {
    ...
    market_fallback: "失敗時に別ソースへ切替",
    market_fallback_help: "現在のフィードが失敗したときにソースを切り替えます。",
...
const RU_TEXT: UiText = UiText {
    ...
    market_fallback: "Использовать другой источник при сбое",
    market_fallback_help: "Переключает источник, если текущий поток недоступен.",
...
const AR_TEXT: UiText = UiText {
    ...
    market_fallback: "استخدام مصدر بديل عند الفشل",
    market_fallback_help: "يبدل المصدر عندما يفشل البث الحالي.",
    ...
    network_proxy_http_example: "\u{2066}http://127.0.0.1:7890\u{2069}",
    network_proxy_socks_example: "\u{2066}socks5://127.0.0.1:1080\u{2069}",
...
mod tests {
    ...
    fn arabic_static_ui_text_isolates_ltr_tokens() {
        ...
        assert_eq!(
            ar_text.network_proxy_http_example,
            "\u{2066}http://127.0.0.1:7890\u{2069}"
        );
        assert_eq!(
            ar_text.network_proxy_socks_example,
            "\u{2066}socks5://127.0.0.1:1080\u{2069}"
        );
        assert_eq!(
            text(Locale::En).network_proxy_http_example,
            "http://127.0.0.1:7890"
        );
        assert_eq!(
    ...
    fn localized_settings_help_fields(text: &'static UiText) -> Vec<(&'static str, &'static str)> {
        vec![
            ...
            ("market_fallback_help", text.market_fallback_help),
    ...
    fn primary_static_ui_fields(text: &'static UiText) -> Vec<(&'static str, &'static str)> {
        vec![
            ...
            ("market_fallback", text.market_fallback),
            ...
            ("runtime_fallback", text.runtime_fallback),
    ...
    const ALLOWED_IDENTICAL_TECHNICAL_UI_FIELDS: &[AllowedIdenticalTechnicalUiField] = &[
        ...
        AllowedIdenticalTechnicalUiField {
            field_name: "network_proxy_http_example",
            reason: "Proxy URL examples must remain literal configuration examples.",
        },
        AllowedIdenticalTechnicalUiField {
            field_name: "network_proxy_socks_example",
            reason: "Proxy URL examples must remain literal configuration examples.",
        },
        AllowedIdenticalTechnicalUiField {
